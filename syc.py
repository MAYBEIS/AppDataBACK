...
# 案例1：Local目录下的Syncthing应用
# 系统路径：C:/Users/Administrator.DESKTOP-L8LTP8H/AppData/Local/Syncthing
# 相对路径：Local/Syncthing

# 案例2：Roaming目录下的IDM应用
# 系统路径：C:/Users/Administrator.DESKTOP-L8LTP8H/AppData/Roaming/IDM
# 相对路径：Roaming/IDM

# 案例3：LocalLow目录下的应用（假设）
# 系统路径：C:/Users/Administrator.DESKTOP-L8LTP8H/AppData/LocalLow/SomeApp
# 相对路径：LocalLow/SomeApp

# 案例4：嵌套的日志文件路径
# 系统路径：C:/Users/Administrator.DESKTOP-L8LTP8H/AppData/Local/Syncthing/index-v0.14.0.db
# 相对路径：Local/Syncthing/_gsdata_/2024-1119-200054-DESKTOP-L8LTP8H-Syncthing.log

# 案例5：带磁盘映射的路径
# 系统路径：C:/Users/Administrator.DESKTOP-L8LTP8H/AppData/Local/Syncthing
# 映射路径：M:/_ProFile/AppData/Local/Syncthing
# 相对路径：Local/Syncthing
# SKIP_RELATIVE_PATHS = [
#     'Local/Syncthing/_gsdata_',  # 跳过Syncthing的日志目录
#     'Roaming/IDM/_gsdata_',      # 跳过IDM的日志目录
#     'Local/Temp',                # 跳过所有Temp目录
# ]